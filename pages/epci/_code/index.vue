  ...
  <div>
    ...
    <div class="mt-16 font-body grid grid-cols-8 grid-rows-4 gap-8">
      ...
      <div class="bg-black text-white p-4 col-span-2 row-span-1">
        ...
        <div class="text-4xl font-semibold">{{epci.communes_aggregate.aggregate.sum.population}}</div>
      </div>
      ...
      <div class="col-span-4 col-start-5 row-span-1 text-lg font-body text-gray-800 ">
        <ul>
          <li>
            <a :href="`https://fr.wikipedia.org/wiki/${epci.nom}`" target="_blank">Wikipedia
          ...
          <li>
            <a :href="`https://www.banatic.interieur.gouv.fr/V5/recherche-de-groupements/fiche-raison-sociale.php?siren=${epci.code_epci}`" target="_blank">Base nationale sur l'intercommunalité
